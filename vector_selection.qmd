...
my.map <- tm_shape(seoul_gu) + tm_polygons(lwd = 2, col = "gray95") +
  tm_shape(starbucks_seoul_real) + tm_dots(size = 0.2, col = "gray70") +
  tm_shape(seoul_subst) + tm_dots(size = 0.2, col = "#377eb8") +
  tm_shape(starbucks_closest_station_unique) + tm_dots(size = 0.2, col = "#e41a1c") +
  tm_legend(legend.position = c(0.81, 0.03)) +
  tm_layout(inner.margins = c(0.06, 0.04, 0.04, 0.04)) + 
  tm_add_legend(type = "symbol", size = 0.80, col = c("#377eb8", "#e41a1c", "gray50"), shape = 16, labels = c("Subway Stations (401)", "Nearest Starbucks (254)", "Starbucks (680)"), title = "") 
my.map
```
...
my_map <- tm_shape(seoul_gu) + tm_polygons(lwd = 2, col = "gray95") +
  tm_shape(starbucks_seoul_real) + tm_dots(size = 0.3, col = "gray70") +
  tm_shape(seoul_subst) + tm_dots(size = 0.3, col = "#377eb8") +
  tm_shape(starbucks_closest_station_unique) + tm_dots(size = 0.3, col = "#e41a1c") +
  tm_legend(legend.title.size = 1.25, legend.text.size = 1.25, legend.position = c(0.80, 0.05)) +
  tm_add_legend(type = "symbol", size = 0.80, col = c("#377eb8", "#e41a1c", "gray70"), shape = 16, labels = c("Subway Stations (401)", "Nearest Starbucks (254)", "Starbucks (680)"), title = "") + 
  tm_layout(inner.margins = c(0.06, 0.04, 0.04, 0.04)) + 
